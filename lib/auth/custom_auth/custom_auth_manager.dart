...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    mscAppAuthUserSubject.add(
      MscAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MscAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MscAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MscAppAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    mscAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
